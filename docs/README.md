...
- **[../README.md](../README.md)** — what it is, quick start, security, config,
  the trust-dialog flow, and the API at a glance.
- **[ARCHITECTURE.md](ARCHITECTURE.md)** — runtime module map, data flow, the
  readiness-detection approach, and the security model.
